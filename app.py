...
if uploaded_files:
    ...
    if all_frames:
        ...
        column_mapping = {
            ' الرقم العشوائي': 'كود الاوردر',  # العمود Q
            'الإسم': 'اسم العميل',  # العمود X
            'العنوان': 'العنوان',  # العمود AA
            'المدينة': 'المدينة',  # العمود AC
            'موبايل(1)': 'رقم موبايل العميل',  # العمود Y
            'حالة الاوردر': 'حالة الاوردر',  # العمود H
            'اخر ملاحظة على الاوردر': 'الملاحظات',  # العمود AJ
            'اسم المنتج': 'اسم الصنف',  # العمود AN
            'اللون': 'اللون',  # العمود AP
            'المقاس': 'المقاس',  # العمود AQ
            'الكمية': 'الكمية',  # العمود AR
            'Total': 'الإجمالي مع الشحن'  # العمود M
        }
